...
ground=cfiles.loadimagesize('D:\history\game\ground2.jpg', 800, 80)
onground=True

background=cfiles.loadimagesize('D:\history\game\oCDOG4.jpg', screen.get_width(), screen.get_height())

gidle=cfiles.getcutpic('D:/history\game/2plan/2 Owlet_Monster/Owlet_Monster_Idle_4.png', 4, 3)
gwalk=cfiles.getcutpic('D:/history\game/2plan/2 Owlet_Monster/Owlet_Monster_Walk_6.png', 6, 3)
grun=cfiles.getcutpic('D:/history\game/2plan/2 Owlet_Monster/Owlet_Monster_Run_6.png', 6, 3)
gjump=cfiles.getcutpic('D:/history/game/2plan/2 Owlet_Monster/Owlet_Monster_Jump_8.png', 8, 3)
pix=cfiles.getcutpic('D:\history\game\image-Photoroom.png', 1, 0.1)
...
def get_colliding_blocks(player_rect):
    ...
    min_x=int((player_rect.left-camerax)//tile_sizes-2)
    max_x=int((player_rect.right-camerax)//tile_sizes+2)
    ...
    min_y=int((player_rect.top-cameray)//tile_sizes-2)
    max_y=int((player_rect.bottom-cameray)//tile_sizes+2)
    ...
    for event in pygame.event.get():
        ...
        if event.type==pygame.KEYDOWN:
            ...
            if event.key==pygame.K_e:
                if inventory.inv_state=='on':
                    inventory.inv_state='off'
                else:
                    inventory.inv_state='on'
